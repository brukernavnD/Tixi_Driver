...
#include "Tixi_DriverCharacter.generated.h"

//Forward declaration
class UDialogueComponent;
class UTicsComponent;
...
UCLASS(config=Game)
class ATixi_DriverCharacter : public ACharacter
{
	GENERATED_BODY()
